...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 570.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 105.0, 90.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 13.0, 450.0, 136.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 330.0, 105.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 255.0, 554.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 590.5, 107.0, 49.0 ],
					"text" : "window size 1302 492 1437 969, window exec"
				}
...
,
					"patching_rect" : [ 686.0, 310.5, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 660.0, 200.5, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
,
					"patching_rect" : [ 475.5, 140.0, 38.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 660.0, 224.0, 71.0, 73.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 390.0, 105.0, 73.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "live.tab[2]",
							"parameter_mmax" : 3,
							"parameter_shortname" : "live.tab[2]",
							"parameter_enum" : [ "LoopBack", "Studio 5", "SPIRAL", "JACK" ],
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 519.5, 203.5, 42.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 475.5, 203.5, 42.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 570.0, 74.0, 22.0 ],
					"text" : "dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 475.5, 166.5, 75.0, 28.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 399.5, 429.0, 195.0, 429.0, 195.0, 360.0, 88.5, 360.0 ],
					"order" : 0,
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 399.5, 429.0, 195.0, 429.0, 195.0, 360.0, 33.0, 360.0 ],
					"order" : 1,
					"source" : [ "obj-39", 0 ]
				}
